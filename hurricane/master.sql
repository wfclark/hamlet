...
drop view if exists vw_quadrent_1;

drop view if exists vw_quadrent_2;

drop view if exists vw_quadrent_3;

drop view if exists vw_quadrent_4;
...
select st_union(a.geom,b.geom) ::geometry(polygon,4326) as geom from vw_quadrent_1 as a, vw_quadrent_2 as b;

create or replace view vw_quadrent_34 as
select st_union(a.geom,b.geom) ::geometry(polygon,4326) as geom from vw_quadrent_3 as a, vw_quadrent_4 as b


create or replace view vw_quadrent_1234 as
select st_union(a.geom,b.geom) ::geometry(polygon,4326) as geom from vw_quadrent_12 as a, vw_quadrent_34 as b
