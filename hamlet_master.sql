...
snow_accum_shp2pgsql = 'ogr2ogr -f "PostgreSQL" PG:"user=postgres dbname=hamlet password=9502f8c6-ca21-44d7-bf02-2d5a7dc471fa"'+ ' '+ snow_accum_shp  + ' ' + '-t_srs EPSG:4326 -nln snow_accum'
...
conn_string = "dbname='hamlet' user='postgres' password='9502f8c6-ca21-44d7-bf02-2d5a7dc471fa'"
